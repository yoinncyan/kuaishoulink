...
- 种子范围：VPN 核心、VPN 产品/协议、企业远程办公、跨境电商、外贸网络、海外专线、代理 IP、防关联、异地组网、网络加速和游戏加速等 58 个初始种子，并对 40 个高关联结果做二级扩展。
- 原始建议记录：2,427 条。
- 规范化后的提纯唯一词：1,537 条。
- 建议用于快手采集：1,087 条。
- 长尾词：1,370 条。
- 剔除噪声：95 条，保留剔除原因供复核。
- 用户明确要求“加速器”相关词全部保留；当前保留 106 条，剔除 0 条。游戏加速器、手游加速器、回国加速器、海外加速器及其下载/推荐/配置词只分类标记，不因泛化或游戏属性删除。
